...
public class CategoryB extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, SearchView.OnQueryTextListener {

    private static final String URL_PRODUCTS = "http://192.168.43.131/verifyhut/viewproduct/api3.php";
    //
    private static final String url_cari = "http://192.168.43.131/verifyhut/search/cari_data.php";

    private static final String TAG = CategoryB.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)findViewById(R.id.recyclerViewCategoryB);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_PRODUCTS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter = new ProductAdapter2(CategoryB.this, productList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CategoryB.this,error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(CategoryB.this);
