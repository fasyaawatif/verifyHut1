...
public class ViewProduct1 extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,SearchView.OnQueryTextListener{

    private static final String URL_PRODUCTS = "http://192.168.43.131/verifyhut/viewproduct/api1.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_product1);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.recyclerViewProduct1);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_PRODUCTS,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                //String pStatus = product.getString("status");
                            ...
                            adapter = new ProductAdapter1(ViewProduct1.this, productList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ViewProduct1.this,error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(ViewProduct1.this);
