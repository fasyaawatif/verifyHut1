...
public class CategoryA extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, SearchView.OnQueryTextListener {

    private static final String URL_PRODUCTS = "http://192.168.43.131/verifyhut/viewproduct/api2.php";
    //
    private static final String url_cari = "http://192.168.43.131/verifyhut/search/cari_data.php";

    private static final String TAG = CategoryA.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)findViewById(R.id.recyclerViewCategoryA);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_PRODUCTS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter = new ProductAdapter2(CategoryA.this, productList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CategoryA.this,error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(CategoryA.this);
