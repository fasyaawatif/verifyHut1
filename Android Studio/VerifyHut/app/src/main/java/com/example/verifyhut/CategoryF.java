...
public class CategoryF extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, SearchView.OnQueryTextListener{

    private static final String URL_PRODUCTS = "http://192.168.43.131/verifyhut/viewproduct/api7.php";
    //
    private static final String url_cari = "http://192.168.43.131/verifyhut/search/cari_data.php";

    private static final String TAG = CategoryF.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_f);
        //
        ...
        recyclerView = (RecyclerView)findViewById(R.id.recyclerViewCategoryF);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_PRODUCTS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter = new ProductAdapter2(CategoryF.this, productList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CategoryF.this,error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(CategoryF.this);
