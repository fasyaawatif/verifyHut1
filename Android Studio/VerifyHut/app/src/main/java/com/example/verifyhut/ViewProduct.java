...
public class ViewProduct extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,SearchView.OnQueryTextListener {

    private static final String URL_PRODUCTS = "http://192.168.43.131/verifyhut/viewproduct/api.php";
    //
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                listProduct listProduct = new listProduct(pName, pBrand, pIngredient, pHalalCertified, pDesc, pType, pID, pStatus);
                                productList.add(listProduct);

                            }

                            adapter = new ProductAdapter(ViewProduct.this, productList);
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(ViewProduct.this);
                ...
                try {
                    ...
                    if (value == 1) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            data.setProductID(obj.getString(TAG_STATUS));
